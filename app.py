...
# Graph section simulation (Historical Performance - Fixed Data Numbers Added)
st.subheader("📈 Simulated Past Performance (Nifty20 vs Nifty 50)")
chart_data = pd.DataFrame({
    'Nifty20 (AI Picked)':,
    'Nifty 50 (Benchmark)': [100, 150, 200, 250, 300, 350]
...
# --- HOW TO USE SECTION ---
st.markdown("---")
with st.expand_visible if False else st.expander("❓ How to Use ProPicks AI"):

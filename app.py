...
# --- COLUMN 1: PROPICKS AI PREMIUM CARDS DASHBOARD (FIXED WITH GRAPHS) ---
...
# Card 1: Bharat Bargains (With Fixed Index Comparison Graph)
...
# Real list with values to guarantee execution and display charts cleanly
n_growth = [100, 120, 140, 170, 190, 218]
a_growth = [100, 160, 240, 380, 490, 575]
final_chart_df = pd.DataFrame({
    'Nifty Index (Benchmark)': n_growth,
    'Bharat Bargains (AI Picked)': a_growth
}, index=['2021', '2022', '2023', '2024', '2025', '2026'])
exp1.line_chart(final_chart_df)
...
# Card 2: Tech Titans (With Fixed US Tech Comparison Graph)
...
t_growth = [100, 110, 125, 135, 150, 160]
at_growth = [100, 130, 155, 180, 205, 216]
final_chart_us_df = pd.DataFrame({
    'S&P Tech Index (Benchmark)': t_growth,
    'Tech Titans (AI Portfolio)': at_growth
}, index=['2021', '2022', '2023', '2024', '2025', '2026'])
exp2.line_chart(final_chart_us_df)
...
# --- COLUMN 2: INDIAN MARKET LISTS (FIXED AVOID LIST INSIDE PRO TIER) ---
...
# 🌟 FIXX 1: Added Avoid list option directly inside Indian Pro Tier layout
...
# --- COLUMN 3: US MARKET LISTS (FIXED AVOID LIST INSIDE PRO TIER) ---
...
# 🌟 FIXX 2: Added Avoid list option directly inside US Pro Tier layout
